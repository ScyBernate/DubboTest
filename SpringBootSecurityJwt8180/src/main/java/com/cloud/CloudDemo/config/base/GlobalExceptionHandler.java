...
import com.cloud.CloudDemo.model.JsonResult;
...
public class GlobalExceptionHandler {
    ...
    //异常格式化模板
    private static String exceptionMsgFormat = "Capture Exception  GlobalException Handler : Code: %s  Message: %s";
    ...
    public ModelAndView nullPointerExceptionHandler(HttpServletRequest req, NullPointerException ex) {
